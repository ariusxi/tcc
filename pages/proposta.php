			...
			<div class="row">
				...
				<div class="ajuste">
					<div class="row">
						...
						<div class="col-md-3">
							...
							<input type="text" name="pesoTotal" class='form-control input-md'>
						</div>
						<div class="col-md-3">
							<label>&nbsp;</label>
							<input type="text" name="precoTabela" class='form-control input-md'>
						</div>
						<div class="col-md-3">
							<label>Frete valor:</label>
							<input type="text" name="valorTotal" class='form-control input-md'>
						</div>
						<div class="col-md-3">
							<label>&nbsp;</label>
							<input type="text" name="valorTabela" class='form-control input-md'>
						</div>
						<div class="col-md-4">
							<label>TAS:</label>
							<input type="text" name="tas" class='form-control input-md' value="<?= $configuracao->tas; ?>">
						</div>
						<div class="col-md-4">
							<label>Despacho:</label>
							<input type="text" name="despacho" class='form-control input-md' value="<?= $configuracao->despacho; ?>">
						</div>
						<div class="col-md-4">
							<label>Pedagio:</label>
							<input type="text" name="pedagio" class='form-control input-md'>
						</div>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-4">
					<label>
						...
						<input type="text" name="lance_inicial" class='form-control input-md' placeholder="Valor inicial">
						<span>Lance minimo R$</span>
						<input type="text" name="lance_minimo" class='form-control input-md' placeholder="Valor minimo">
					</label>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-6">
					...
					<textarea class='form-control input-md' id='info-cliente' placeholder="Informações sobre prazos, preços, etc" maxlength="1000"></textarea>
				</div>
				<div class="col-md-6">
					<span>Aviso</span>
					<p>
				...
				<div class="col-md-6">
					...
					<textarea class='form-control input-md' placeholder="Informações sobre prazos, preços, etc"></textarea>
				</div>
				<div class="col-md-6">
					<span>Aviso</span>
				...
				<div class="col-md-12">
					<button class='submit proposta' id=''>Fazer proposta</button>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function initMap(address) {
  	...
  	$("#info-cliente").keyup(function(){
  		var quantidade = $("#info-cliente").val().length;
